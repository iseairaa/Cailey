const database = {
    ...
    tagalog: {
        words: {
            ...
            hard: ["MA-SA-YA", "PA-A-RA-LAN", "MA-LA-KAS", "KA-I-BI-GAN", "MA-BA-BAW", "HA-YOP", "BU-LAK-LAK", "MA-HI-WA-GA", "AL-MU-SAL", "BA-HAG-HA-RI", "MA-GA-LANG", "MA-TA-LI-NO", "MA-BAN-GO", "MA-LI-NIS", "TA-HI-MIK"]
        },
        phrases: {
            easy: ["ANG A-SO AT PU-SA", "MA-LA-KING BO-LA", "MA-LI-WA-NAG NA A-RAW", "MA-BA-IT NA BA-TA", "ANG A-MA AT I-NA", "MA-SA-YANG TA-O", "MA-TA-AS NA PU-NO", "IS-DA SA TU-BIG", "MA-PU-LANG SA-YA", "MA-TA-AS NA LO-BO", "MA-LI-IT NA I-BON", "ANG MGA MA-TA", "ANG KA-MAY KO", "GA-BI NA NA-MAN", "BU-HOK NI A-NA"],
            medium: ["PU-TING PA-PEL AT AK-LAT", "MA-LA-WAK NA DA-GAT", "MANG-GA SA ME-SA", "MA-TA-AS NA LA-NGIT", "MA-LI-IT NA BA-HAY", "MA-KA-PAL NA KU-MOT", "U-NAN SA BA-HAY", "MA-LA-KAS NA U-LAN", "MGA LA-MOK SA GU-BAT", "MA-LI-NIS NA I-LOG", "SA-PA SA BU-KID", "MA-LA-MIG NA LA-WA", "AKO AY MAY PANGA-LAN", "KA-PE AT TI-NA-PAY", "MANG-GA AT SA-GING"],
            hard: ["MA-SA-YANG PA-A-RA-LAN", "MA-LA-KAS NA KA-I-BI-GAN", "MA-HI-WA-GANG BA-HAG-HA-RI", "MA-BA-NGONG BU-LAK-LAK", "MA-SA-RAP NA AL-MU-SAL", "MA-GA-LANG NA BA-TA", "MA-TA-LI-NONG TA-O", "MA-LI-NIS NA BA-HAY", "TA-HI-MIK NA GAB-I", "MA-BA-BAW NA SA-PA", "MA-BU-TING BA-TA", "MA-LIK-HA-IN SI ELSA", "E-RO-PLA-NO SA LA-NGIT", "OS-PI-TAL SA BA-YAN", "TSI-NE-LAS NI LO-LA"]
        },
        stories: {
            easy: [
